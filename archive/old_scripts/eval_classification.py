...
def transform_wide_to_long(df_wide, true_label_col="int_score"):
    ...
    print(
        "Reshaping data for the following models from CSV:",
        [c.replace("predicted_label_", "") for c in pred_cols],
    )
...
if __name__ == "__main__":
    ...
    for df_annotator, name in [
        (df_gemini, "Gemini 2.5 Flash"),
        (df_human, human_display_name),
    ]:
