...
class SimpleContentFilter:
    ...
    def filter_dataset(
        self, data: pd.DataFrame, text_column: str = "text", bad_word_threshold: int = 2
...
def main():
    ...
    clean_data.to_csv(
        "archive/old_results/danish_filtered_data_updated.csv",
        index=False,
        encoding="utf-8",
    )
    ...
    print("\nFiles saved:")
    print("  Clean data: archive/old_results/danish_filtered_data_updated.csv")
    print("  Problematic data: archive/old_results/problematic_data.csv")
