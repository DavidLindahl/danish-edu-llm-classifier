...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_path",
        type=str,
        default="models/xlm-_Danish=5000_06.22-11.17_CDW-CE",
        help="Local path to the model directory.",
    )
    parser.add_argument(
        "--repo_id",
        type=str,
        default="Davidozito/full-finetuning-classification",
        help="Hub repository ID (e.g., YourUsername/YourModelName).",
    )
